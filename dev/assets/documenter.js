...
window.MathJax = {
  "tex": {
    ...
    "macros": {
      ...
      "BRANCHES": "\\EDGES",
      "PR": "\\mathbf{p}^{\\text{r}}",
      "lambdaPf": "{\\lambda}^{\\text{pf}}",
      "nuThermalPto": "{\\nu}^{\\text{pt}}",
      "muWrMax": "\\bar{\\mu}^{\\text{wr}}",
      "gtt": "g^{\\text{tt}}",
      "muWiMin": "\\underline{\\mu}^{\\text{wi}}",
      "muAngleDiffMax": "\\bar{\\mu}^{\\theta}",
      "wmin": "\\underline{\\mathbf{w}}",
      "muPtMax": "\\bar{\\mu}^{\\text{pt}}",
      "muQt": "{\\mu}^{\\text{qt}}",
      "PS": "\\mathcal{P}",
      "nuThermalSfr": "{\\nu}^{\\text{sf}}",
      "lambdaQf": "{\\lambda}^{\\text{qf}}",
      "muPgMax": "\\bar{\\mu}^{\\text{pg}}",
      "muQgMin": "\\underline{\\mu}^{\\text{qg}}",
      "gtf": "g^{\\text{tf}}",
      "muWrMin": "\\underline{\\mu}^{\\text{wr}}",
      "lambdat": "{\\lambda}^{\\text{t}}",
      "EDGES": "\\mathcal{E}",
      "NODES": "\\mathcal{N}",
      "VA": "\\boldsymbol{\\theta}",
      "gff": "g^{\\text{ff}}",
      "muPgMin": "\\underline{\\mu}^{\\text{pg}}",
      "nuThermalQto": "{\\nu}^{\\text{qt}}",
      "qgmax": "\\overline{{q}}^{\\text{g}}",
      "pgmin": "\\underline{{p}}^{\\text{g}}",
      "muQfMax": "\\bar{\\mu}^{\\text{qf}}",
      "QG": "\\mathbf{q}^{\\text{g}}",
      "SD": "S^{\\text{d}}",
      "omegat": "\\omega^{\\text{t}}",
      "muPg": "{\\mu}^{\\text{pg}}",
      "wrmin": "\\underline{\\mathbf{w}}^{\\text{re}}",
      "muWi": "{\\mu}^{\\text{wi}}",
      "nuThermalQfr": "{\\nu}^{\\text{qf}}",
      "LOADS": "\\mathcal{L}",
      "muQfMin": "\\underline{\\mu}^{\\text{qf}}",
      "SG": "S^{\\text{g}}",
      "QD": "{q}^{\\text{d}}",
      "DVA": "\\Delta\\boldsymbol{\\theta}",
      "SF": "S^{\\text{f}}",
      "muPfMax": "\\bar{\\mu}^{\\text{pf}}",
      "muPt": "{\\mu}^{\\text{pt}}",
      "wmax": "\\overline{\\mathbf{w}}",
      "muPtMin": "\\underline{\\mu}^{\\text{pt}}",
      "GENERATORS": "\\mathcal{G}",
      "PD": "{p}^{\\text{d}}",
      "lambdaQ": "\\lambda^{\\text{q}}",
      "RHO": "\\boldsymbol{\\rho}",
      "wrmax": "\\overline{\\mathbf{w}}^{\\text{re}}",
      "vmmax": "\\overline{{v}}",
      "wm": "\\mathbf{w}",
      "muWmMin": "\\underline{\\mu}^{\\text{w}}",
      "muQtMax": "\\bar{\\mu}^{\\text{qt}}",
      "btf": "b^{\\text{tf}}",
      "wimax": "\\overline{\\mathbf{w}}^{\\text{im}}",
      "dvamin": "\\underline{\\Delta} \\theta",
      "GS": "{g}^{\\text{s}}",
      "pgmax": "\\overline{{p}}^{\\text{g}}",
      "muPf": "{\\mu}^{\\text{pf}}",
      "muAngleDiff": "{\\mu}^{\\theta}",
      "lambdaPt": "{\\lambda}^{\\text{pt}}",
      "MU": "\\boldsymbol{\\mu}",
      "bff": "b^{\\text{ff}}",
      "BS": "{b}^{\\text{s}}",
      "muQgMax": "\\bar{\\mu}^{\\text{qg}}",
      "muQf": "{\\mu}^{\\text{qf}}",
      "LMDA": "\\boldsymbol{\\lambda}",
      "lambdaP": "\\lambda^{\\text{p}}",
      "QF": "\\mathbf{q}^{\\text{f}}",
      "dvamax": "\\overline{\\Delta} \\theta",
      "QT": "\\mathbf{q}^{\\text{t}}",
      "V": "\\mathbf{V}",
      "PG": "\\mathbf{p}^{\\text{g}}",
      "wimin": "\\underline{\\mathbf{w}}^{\\text{im}}",
      "nuThermalfr": "{\\nu}^{\\text{f}}",
      "muWmMax": "\\bar{\\mu}^{\\text{w}}",
      "im": "\\mathbf{j}",
      "wi": "\\mathbf{w}^{\\text{im}}",
      "PT": "\\mathbf{p}^{\\text{t}}",
      "nuThermalto": "{\\nu}^{\\text{t}}",
      "VM": "\\mathbf{v}",
      "lambdaf": "{\\lambda}^{\\text{f}}",
      "omegaf": "\\omega^{\\text{f}}",
      "omegar": "\\omega^{\\text{re}}",
      "gft": "g^{\\text{ft}}",
      "muQg": "{\\mu}^{\\text{qg}}",
      "muQtMin": "\\underline{\\mu}^{\\text{qt}}",
      "muWr": "{\\mu}^{\\text{wr}}",
      "muWiMax": "\\bar{\\mu}^{\\text{wi}}",
      "qgmin": "\\underline{{q}}^{\\text{g}}",
      "nuThermalPfr": "{\\nu}^{\\text{pf}}",
      "bft": "b^{\\text{ft}}",
      "muWm": "{\\mu}^{\\text{w}}",
      "nuThermalSto": "{\\nu}^{\\text{st}}",
      "lambdaQt": "{\\lambda}^{\\text{qt}}",
      "omegai": "\\omega^{\\text{im}}",
      "muAngleDiffMin": "\\underline{\\mu}^{\\theta}",
      "muPfMin": "\\underline{\\mu}^{\\text{pf}}"
    },
    "tags": "ams"
  },
  "options": {
